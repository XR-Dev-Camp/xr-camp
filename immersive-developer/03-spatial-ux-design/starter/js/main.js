...
if (!supportsWebGL2()) {
  ...
  // TODO 10: wire the "Move smoothly" checkbox (#smooth-toggle) to
  // app.setSmooth(checked), and each lock-mode radio button
  // (input[name="lock-mode"]) to app.setGoalsLockMode(value) with its
  // 'world' / 'body' / 'view' value, when it becomes checked. Until you do,
  // the checkbox and the radio buttons are visible but do nothing.
