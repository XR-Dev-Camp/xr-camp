...
// turning the renderer's XR support on (TODO 2), and a way for xr.js to tell
// the engine "a headset has taken over now" so OrbitControls stops fighting
// the headset's own head tracking (TODO 3). Nothing about the exhibit's
// objects or its render loop changes: `renderer.setAnimationLoop` already
// runs three.js's XR frame loop automatically once a session is set (see
// xr.js), so this file needed no change there at all.
...
export function createApp(container) {
  ...
  // exhibit's seated-VR origin (TODO 2): 1.6 m is an ordinary adult eye
  // height, seated or standing, and 4.2 m keeps the whole exhibit in easy,
  // comfortable view without leaning or turning around (TODO 4, xr.js).
  ...
  // TODO 3: called by xr.js when a VR session starts or ends. OrbitControls
