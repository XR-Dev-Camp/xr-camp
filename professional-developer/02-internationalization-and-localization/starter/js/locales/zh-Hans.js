...
// native Chinese speaker's review. See "Translation QA checklist" in the
// README before this ships to learners. Any key missing here falls back to
// English (i18n.js).
//
// TODO 5: like es.js, this file is deliberately missing 'motion.hint' and
// 'stats.openedRelative'. Translate them from en.js into plain, simple
// Simplified Chinese and add them below. Keep sentences short — this
// audience includes complete beginners to both code and, for some readers,
// to reading long on-screen English.
