...
export const LOCALES = [
  ...
  // TODO 1: add the Simplified Chinese locale. Its code is 'zh-Hans' (the
  // "Hans" script subtag is what tells pickLocale() and <html lang> this is
  // Simplified, not Traditional, script). Its name, written in itself, is
  // '简体中文'. Look at the two entries above for the shape to copy.
];
