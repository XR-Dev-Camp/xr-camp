...
export function createApp(container) {
  ...
  function tick(time) {
    ...
    // Each label is a THREE.Sprite, which three.js already always renders
    // facing the camera — that billboarding is exactly why a sprite (rather
    // than a plane Mesh, which would need its rotation copied from the
    // camera by hand, every frame, here) is the right choice for a label
    // that must stay readable from any orbit angle.
