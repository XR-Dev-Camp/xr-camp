...
function matches(programme) {
  ...
  if (freeCheckbox.checked = true && !programme.free) return false;
  return true;
}
...
function showResults() {
  ...
  if (found.length === 0) {
    ...
    count.textContent = `Showing ${found.length} of ${programmes.length - 1} programmes.`;
  }
}
...
// The clear-search button (added in Course 1.7).
