...
**Course:** `web-developer` · **Lesson:** `web-accessibility-foundations-05` · **Estimated time:** 600 minutes
...
[Open this lesson on xrcamp.dev](https://xrcamp.dev/lessons/web-accessibility-foundations-05)
