...
Refactor a tangled 3D scene script into small components, each with one clear job.
...
[Open this lesson on xrcamp.dev](https://xrcamp.dev/lessons/application-architecture-and-maintainable-code-03)
