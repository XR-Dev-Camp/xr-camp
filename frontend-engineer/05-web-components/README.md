...
Wrap a 3D model viewer in your own custom element with a slot for its accessible description.
...
[Open this lesson on xrcamp.dev](https://xrcamp.dev/lessons/web-components-05)
