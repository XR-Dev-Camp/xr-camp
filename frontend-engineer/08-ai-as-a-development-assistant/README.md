...
Ask an AI assistant to explain an unfamiliar Three.js snippet, then check every claim against the official documentation.
...
[Open this lesson on xrcamp.dev](https://xrcamp.dev/lessons/ai-as-a-development-assistant-08)
