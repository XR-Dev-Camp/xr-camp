...
> **This is a longer lesson (38 sessions).** Take it one step at a time: each session still ends with something you made, and it is fine to take a short break between steps.
...
3. Keep your build checklist, user guide, README, and changelog in your learner journal and portfolio. Share them with other developers: see [where to share your work and ask for help](../../docs/en/community.md).
