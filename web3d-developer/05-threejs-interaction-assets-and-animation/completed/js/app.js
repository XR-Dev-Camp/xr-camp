...
// renderer, scene, camera, controls, and render-loop setup, and extended
// with what a model explorer needs: loading the two glTF items (via
// exhibit.js and loader.js), picking an item with a ray from the pointer,
// highlighting the selected one, and driving an AnimationMixer per model.
// No DOM text or button wiring happens here, so main.js can change the
// page's controls without touching this file.
