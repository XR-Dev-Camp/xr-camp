...
const server = createServer(async (req, res) => {
  try {
    ...
    // TODO 11: wire this capstone's own two routes, the same way as every
    // other authenticated route above -- call requireAuth, send 401 if it
    // fails, then call describeScene (POST, descriptionMatch[2] truthy) or
    // saveDescription (PUT, descriptionMatch[2] falsy) with
    // (req, res, auth, descriptionMatch[1]). Without this, both handlers in
    // routes.js are unreachable, no matter what TODO 9 and TODO 10 do.
