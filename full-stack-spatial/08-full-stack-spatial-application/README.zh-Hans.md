...
**课程:** `full-stack-spatial` · **课时:** `full-stack-spatial-application-08` · **预计时长:** 1500 分钟

---

> Release a production-style full-stack spatial application.
...
[在 xrcamp.dev 上打开本课](https://xrcamp.dev/lessons/full-stack-spatial-application-08)
