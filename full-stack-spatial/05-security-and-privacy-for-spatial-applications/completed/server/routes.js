...
// annotations, and one secret-gated debug endpoint. FIXED: TODO 5 (getScene
// now checks ownership/visibility on every request), TODO 7 (a scene's
// location is rounded before it is ever stored), TODO 1 (annotation text is
// sanitized before it is stored). TODO 4's other half (the admin endpoint's
// secret) is fixed in config.js, not here -- this file only imports it.
