<!-- 本文件由 scripts/build-readmes.mjs 根据 catalog.json 生成。请修改脚本，而不是本文件。 -->

# XR Camp

**Language / Idioma / 语言:** [English](README.md) · [Español](README.es.md) · 简体中文

> 一所面向沉浸式网络的免费学校。从你写下的第一行代码开始，学习构建在浏览器中运行的网站、3D 世界以及虚拟现实和增强现实体验。

XR Camp **完全免费，面向所有人**。它首先为**拉丁美洲和中国的女性**而建，包括从未写过代码的女性；课程由女性专家以及致力于女性赋权的男性支持者共同创作。
...
八个阶段，从第一次点击到专业开发者。每个阶段都以一个你亲手发布的项目结束，而且每个阶段本身都有价值。
...
| [2 · 成为前端工程师](frontend-engineer/README.zh-Hans.md) | 可以安装到手机、离线运行并使用实时数据的网页应用。 | 145 次学习 · 约 8 个月 | 9 课中 3 课 |
...
✅ 已完成表示该课程的英文版已经完成（西班牙语和中文翻译正在进行中）。🚧 表示课程正在编写。
...
| 7 | [Developer Tools, Debugging, and Testing](web-developer/07-developer-tools-debugging-and-testing/README.zh-Hans.md) | 9 小时 · 12 次学习 | ✅ 已完成 |
| 8 | [Git, GitHub, and Publishing](web-developer/08-git-github-and-publishing/README.zh-Hans.md) | 9 小时 · 12 次学习 | ✅ 已完成 |
| 9 | [Phase 1 Capstone - Web Developer Portfolio](web-developer/09-web-developer-portfolio/README.zh-Hans.md) | 15 小时 · 20 次学习 | ✅ 已完成 |

### 阶段 2 · 成为前端工程师

| # | 课程 | 时长 | 状态 |
| --- | --- | --- | --- |
| 1 | [Modern JavaScript](frontend-engineer/01-modern-javascript/README.zh-Hans.md) | 14 小时 · 19 次学习 | ✅ 已完成 |
| 2 | [The Document Object Model and Dynamic Interfaces](frontend-engineer/02-the-document-object-model-and-dynamic-interfaces/README.zh-Hans.md) | 10 小时 · 14 次学习 | ✅ 已完成 |
| 3 | [Application Architecture and Maintainable Code](frontend-engineer/03-application-architecture-and-maintainable-code/README.zh-Hans.md) | 12 小时 · 16 次学习 | ✅ 已完成 |
| 4 | [APIs, JSON, and Asynchronous Applications](frontend-engineer/04-apis-json-and-asynchronous-applications/README.zh-Hans.md) | 12 小时 · 16 次学习 | 🚧 即将推出 |
| 5 | [Web Components](frontend-engineer/05-web-components/README.zh-Hans.md) | 10 小时 · 14 次学习 | 🚧 即将推出 |
| 6 | [Progressive Web Applications](frontend-engineer/06-progressive-web-applications/README.zh-Hans.md) | 12 小时 · 16 次学习 | 🚧 即将推出 |
| 7 | [Git Collaboration and Open Source](frontend-engineer/07-git-collaboration-and-open-source/README.zh-Hans.md) | 9 小时 · 12 次学习 | 🚧 即将推出 |
| 8 | [AI as a Development Assistant](frontend-engineer/08-ai-as-a-development-assistant/README.zh-Hans.md) | 10 小时 · 14 次学习 | 🚧 即将推出 |
...
| # | 课程 | 时长 | 状态 |
| --- | --- | --- | --- |
| 1 | [Web3D Fundamentals](web3d-developer/01-web3d-fundamentals/README.zh-Hans.md) | 14 小时 · 19 次学习 | 🚧 即将推出 |
...
| 6 | [Performance Engineering for Web3D](web3d-developer/06-performance-engineering-for-web3d/README.zh-Hans.md) | 12 小时 · 16 次学习 | 🚧 即将推出 |
| 7 | [Phase 3 Capstone - Interactive Web3D Experience](web3d-developer/07-interactive-web3d-experience/README.zh-Hans.md) | 20 小时 · 27 次学习 | 🚧 即将推出 |

### 阶段 4 · 成为沉浸式开发者

| # | 课程 | 时长 | 状态 |
| --- | --- | --- | --- |
| 1 | [WebXR Foundations](immersive-developer/01-webxr-foundations/README.zh-Hans.md) | 14 小时 · 19 次学习 | 🚧 即将推出 |
| 2 | [XR Input and Interaction](immersive-developer/02-xr-input-and-interaction/README.zh-Hans.md) | 12 小时 · 16 次学习 | 🚧 即将推出 |
| 3 | [Spatial UX Design](immersive-developer/03-spatial-ux-design/README.zh-Hans.md) | 12 小时 · 16 次学习 | 🚧 即将推出 |
...
| # | 课程 | 时长 | 状态 |
| --- | --- | --- | --- |
| 1 | [Backend and API Foundations](full-stack-spatial/01-backend-and-api-foundations/README.zh-Hans.md) | 14 小时 · 19 次学习 | 🚧 即将推出 |
| 2 | [Authentication and User Accounts](full-stack-spatial/02-authentication-and-user-accounts/README.zh-Hans.md) | 10 小时 · 14 次学习 | 🚧 即将推出 |
| 3 | [Databases and Spatial Application Data](full-stack-spatial/03-databases-and-spatial-application-data/README.zh-Hans.md) | 12 小时 · 16 次学习 | 🚧 即将推出 |
| 4 | [Real-Time and Multi-User Applications](full-stack-spatial/04-real-time-and-multi-user-applications/README.zh-Hans.md) | 17 小时 · 23 次学习 | 🚧 即将推出 |
| 5 | [Security and Privacy for Spatial Applications](full-stack-spatial/05-security-and-privacy-for-spatial-applications/README.zh-Hans.md) | 12 小时 · 16 次学习 | 🚧 即将推出 |
| 6 | [AI for Spatial Computing](full-stack-spatial/06-ai-for-spatial-computing/README.zh-Hans.md) | 14 小时 · 19 次学习 | 🚧 即将推出 |
| 7 | [Advanced PWA and Offline Spatial Delivery](full-stack-spatial/07-advanced-pwa-and-offline-spatial-delivery/README.zh-Hans.md) | 10 小时 · 14 次学习 | 🚧 即将推出 |
| 8 | [Phase 5 Capstone - Full-Stack Spatial Application](full-stack-spatial/08-full-stack-spatial-application/README.zh-Hans.md) | 25 小时 · 34 次学习 | 🚧 即将推出 |

### 阶段 6 · 成为专业开发者

| # | 课程 | 时长 | 状态 |
| --- | --- | --- | --- |
| 1 | [Production Deployment and DevOps](professional-developer/01-production-deployment-and-devops/README.zh-Hans.md) | 12 小时 · 16 次学习 | 🚧 即将推出 |
...
| # | 课程 | 时长 | 状态 |
| --- | --- | --- | --- |
| 1 | [Capstone Research and Definition](capstone/01-capstone-research-and-definition/README.zh-Hans.md) | 8 小时 · 11 次学习 | 🚧 即将推出 |
| 2 | [Experience and System Design](capstone/02-experience-and-system-design/README.zh-Hans.md) | 10 小时 · 14 次学习 | 🚧 即将推出 |
| 3 | [Capstone Prototype](capstone/03-capstone-prototype/README.zh-Hans.md) | 12 小时 · 16 次学习 | 🚧 即将推出 |
| 4 | [Capstone Production](capstone/04-capstone-production/README.zh-Hans.md) | 28 小时 · 38 次学习 | 🚧 即将推出 |
| 5 | [Testing, Launch, and Presentation](capstone/05-testing-launch-and-presentation/README.zh-Hans.md) | 12 小时 · 16 次学习 | 🚧 即将推出 |
...
每个项目都必须支持键盘和屏幕阅读器操作，满足 WCAG 2.2 AA 对比度要求，并遵循“减少动态效果”设置。3D 和 XR 绝不能妨碍用户访问核心内容。
